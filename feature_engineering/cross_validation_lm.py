...
k_fold_scores = cross_val_score(linear_model, X, y, cv=k_fold, scoring='neg_mean_squared_error')
...
loo = LeaveOneOut()
linear_model = LinearRegression()
loo_scores = cross_val_score(linear_model, X, y, cv=loo, scoring='neg_mean_squared_error')
...
linear_model = LinearRegression()
lpo_scores = cross_val_score(linear_model, X, y, cv=lpo, scoring='neg_mean_squared_error')
